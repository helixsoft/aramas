...
<div class="scontainer clearfix">
		<div class="content">
			<div class="left">
				...
				<div class="slidewrap09" data-autorotate="5000">
		<ul class="slidecontrols" style="margin-left:350px;margin-top:20px;">
			<li style="float:left;text-decoration:none;"><a href="#sliderName" class="next" style="text-decoration:none;color:#6A6B66;">Brands</a></li><li style="float:left"><a>/</a></li>
			<li style="float:left;text-decoration:none;"><a href="#sliderName" class="prev" style="text-decoration:none;color:#6A6B66;">Testimonials</a></li>
		</ul>
				<div class="bot">
				...
				<div class="down">
		            ...
		            <div class="down-contact-form">
		            	<form id="contact-us" action="" method="post" name="contactForm">
		                 	<input type="text" name="name" value="" class="txt requiredField" placeholder="NAME:">
		                 	<textarea class="txtarea requiredField" name="message" cols="30" rows="10" placeholder="MESSAGE:"></textarea>
		                 	<input type="email" name="email" value="" class="txt requiredField email" placeholder="EMAIL:">
